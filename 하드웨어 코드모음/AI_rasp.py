...
class BpMonitoringSystemByAi:
    ...
    def rp_preprocess(self, file_name, info_dir):
        ...
        path = self.set_path("rp_text.csv")
        select_wave_pd.to_csv(path, mode='w', header=True)
    ...
    def save_model(self, model):
        ...
        :return:
        """
        path = self.set_path("model_save.h5")
        model.save(path)
